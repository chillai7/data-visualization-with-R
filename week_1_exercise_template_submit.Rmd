...
####PUT YOUR CODE HERE
congress115 <- cel %>% filter(congress==115)
congress115 <- select(congress115, 'all_pass', 'dwnom1', 'female')
head(congress115)
gender <- recode(congress115$female, '1'='female', '0'='male') 
congress115 <- add_column(congress115, gender)
congress115$gender
ggplot(congress115,aes(x = dwnom1, y = all_pass, color = gender))+ 
  geom_jitter()+
  scale_color_manual(values = c("red", "blue"))+
  labs(x='idealogy', y='bills passed')
```
...
####PUT YOUR CODE HERE
congress115 <- cel %>% filter(congress==115)
congress115 <- select(congress115, "votepct", "all_pass", 'female', 'majority')
head(congress115)
gender <- recode(congress115$female, '1'='female', '0'='male') 
congress115 <- add_column(congress115, gender)
congress115$gender
inpower <- recode(congress115$majority, '1'='majority', '0'='minority') 
congress115 <- add_column(congress115, inpower)
congress115$inpower
ggplot(congress115,aes(x = votepct, y = all_pass, color = gender))+ 
  geom_jitter()+
...
####PUT YOUR CODE HERE
congress115 <- cel %>% filter(congress==115)
congress115 <- select(congress115, "les", 'majority')
head(congress115)
inpower <- recode(congress115$majority, '1'='majority', '0'='minority') 
congress115 <- add_column(congress115, inpower)
congress115$inpower
ggplot(congress115,aes(x = inpower, y = les))+ 
  geom_boxplot()+
