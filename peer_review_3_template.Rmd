...
# anim_save('plot1.gif', animation = plot1)
...
p1 <- ggplot(my_dat, aes(x = Company, y = Output, fill = Company)) +
        geom_boxplot() 
...
value <- aggregate(Quantity ~ Category, data = dat3, max)
